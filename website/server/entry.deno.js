...
import { _ as _deserializeData, a as _serializeData, v as verifySerializable$1, q as qwikCityPlan } from './q-sFfusfq4.js';
import { s as setServerPlatform2, r as render, m as manifest } from './q-92wkCC35.js';
...
const port = Number(Deno.env.get("PORT") ?? 8e3);
console.log(`Server starter: ${Deno.env.get("APP_URL") || "http://localhost"}:${port}/`);
const handler = async (request, conn) => {
