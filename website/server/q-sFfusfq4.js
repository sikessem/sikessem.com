...
const renderNode = (node, rCtx, ssrCtx, stream, flags, beforeClose) => {
    ...
    if ("string" == typeof tagName) {
        ...
        const handleProp = (rawProp, value, isImmutable) => {
            ...
            if (isSignal(value) && (value = trackSignal(value, isImmutable ? [ 1, elm, value, hostCtx.$element$, rawProp ] : [ 2, hostCtx.$element$, value, elm, rawProp ]), 
...
const processData$1 = (node, rCtx, ssrCtx, stream, flags, beforeClose) => {
    if (null != node && "boolean" != typeof node) {
        if (!isString(node) && "number" != typeof node) {
            ...
            return isPromise(node) ? (stream.write(FLUSH_COMMENT), node.then((node => processData$1(node, rCtx, ssrCtx, stream, flags, beforeClose)))) : void logWarn();
        }
...
const processData = (node, invocationContext) => {
    if (null != node && "boolean" != typeof node) {
        ...
        return isPromise(node) ? node.then((node => processData(node, invocationContext))) : node === SkipRender ? new ProcessedJSXNodeImpl(":skipRender", EMPTY_OBJ, null, EMPTY_ARRAY, 0, null) : void logWarn();
    }
};
...
const s_PpMpiMPB0t0 = () => {
  return /* @__PURE__ */ _jsxC(Slot, null, 3, "7F_0");
};
const layout = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_PpMpiMPB0t0, "s_PpMpiMPB0t0"));
...
const index = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_NuUWtFC0yY0, "s_NuUWtFC0yY0"));
const head = {
...
/** Qwik City Routes (1) */
const routes = [
  [ "/", [ Layout, ()=>IndexRoute ], "/", ["q-gUBrWqMM.js","q-Dt3AIoy4.js"] ],
];
...
export { useLexicalScope as A, getLocale as B, withLocale as C, _fnSignal as D, _jsxS as E, Fragment as F, serverPlugins as G, routes as H, menus as I, trailingSlash as J, cacheModules as K, SkipRender as S, _deserializeData as _, _serializeData as a, _renderSSR as b, _pauseFromContexts as c, componentQrl as d, _jsxQ as e, _wrapSignal as f, _jsxBranch as g, useContext as h, inlinedQrl as i, jsx as j, _jsxC as k, useStylesQrl as l, useStore as m, _weakSerialize as n, useSignal as o, useContextProvider as p, qwikCityPlan as q, useTaskQrl as r, setPlatform as s, Slot as t, useServerData as u, verifySerializable as v, getPlatform as w, noSerialize as x, createContextId as y, basePathname as z };
